...
export function ChildArtistQuickSpecs({ artist }: ChildArtistQuickSpecsProps) {
  const specs = [
    ...
    { label: "Eye Color", value: artist.eyeColor, icon: Eye },
    { label: "Hair Color", value: artist.hair, icon: Sparkles },
    { label: "Guardian Status", value: artist.guardianConsent, icon: ShieldCheck },
  ];
