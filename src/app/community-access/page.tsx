      ...
      <section className="mx-auto max-w-5xl px-6 py-12 lg:px-8 lg:py-20">
        <Reveal>
          <div className="overflow-hidden rounded-[32px] border border-[#D4AF37]/25 bg-white/[0.03] p-7 text-center md:p-12">
            ...
            <div className="mx-auto mt-10 max-w-3xl rounded-3xl border border-white/10 bg-black/20 p-6 text-left md:p-8">
            ...
            <div className="mx-auto mt-8 max-w-3xl rounded-3xl border border-[#D4AF37]/20 bg-[#D4AF37]/[0.05] p-7 text-left md:p-8">
            ...
            <div className="mx-auto mt-6 max-w-3xl rounded-2xl border border-white/10 bg-white/[0.02] p-5">
