...
import { getPendingArtists, getApprovedArtists, getRejectedArtists, getArtistForReview, approveArtist, rejectArtist, getPendingCastingCalls, approveCastingCall, rejectCastingCall, getAdminStats, getAdminPayments, } from "../controllers/admin.controller.js";
const router = Router();
