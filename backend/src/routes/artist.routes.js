...
import { createArtistProfile, getArtistProfile, updateArtistProfile, uploadArtistPhotos, } from "../controllers/artist.controller.js";
...
router.put("/profile", authenticate, updateArtistProfile);
