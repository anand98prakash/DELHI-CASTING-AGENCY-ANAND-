 ...
 */
export function decryptMfaSecret(encryptedData) {
 ...
 */
export function generateTotp(secretBase32, timeStep = Math.floor(Date.now() / 1000 / 30)) {
 ...
 */
export async function compareBackupCode(plainCode, codeHash) {
