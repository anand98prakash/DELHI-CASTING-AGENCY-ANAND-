  ...
  return (
    ...
    >
      <div className="flex flex-col flex-1">
        ...
        <div className="relative aspect-[16/10] w-full overflow-hidden rounded-2xl bg-gray-100 my-3 border border-gray-200 shrink-0 block">
          <Image
            src={category.image}
            alt={category.title}
            fill
